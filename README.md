...
Welcome to my profile! I'm a passionate **Data Analyst** and **AI Enthusiast** with a strong background in data science and analytics, specializing in AI-driven insights and intelligent insurance analytics. I transform complex data into actionable insights and build intelligent systems that drive real-world impact. 🚀

[![GitHub followers](https://img.shields.io/github/followers/shivams-15?label=Follow&style=social)](https://github.com/shivams-15)
...
- **Experience**: Data Analyst at Ennovation pvt ltd | Hanover Re

I'm driven by curiosity, innovation, and a commitment to using data to solve challenging problems. I love exploring emerging technologies and collaborating on projects that make a difference. My work spans from handling complex insurance datasets to developing cutting-edge AI models and interactive dashboards that power real-world applications.
...
[![MySQL](https://img.shields.io/badge/MySQL-00758F?style=flat&logo=mysql&logoColor=white)](https://www.mysql.com/) [![PostgreSQL](https://img.shields.io/badge/PostgreSQL-336791?style=flat&logo=postgresql&logoColor=white)](https://www.postgresql.org/) [![MongoDB](https://img.shields.io/badge/MongoDB-47A248?style=flat&logo=mongodb&logoColor=white)](https://www.mongodb.com/) [![SQL Server](https://img.shields.io/badge/SQL%20Server-CC2927?style=flat&logo=microsoft-sql-server&logoColor=white)](https://www.microsoft.com/sql-server)

### Cloud & Deployment  
[![AWS](https://img.shields.io/badge/AWS-232F3E?style=flat&logo=amazon-aws&logoColor=white)](https://aws.amazon.com/) [![Streamlit](https://img.shields.io/badge/Streamlit-FF4B4B?style=flat&logo=streamlit&logoColor=white)](https://www.streamlit.io/) [![Jupyter](https://img.shields.io/badge/Jupyter-F37726?style=flat&logo=jupyter&logoColor=white)](https://jupyter.org/)

### LLMs & Generative AI  
[![OpenAI](https://img.shields.io/badge/OpenAI-ChatGPT-blue?style=flat&logo=openai&logoColor=white)](https://openai.com/) [![LangChain](https://img.shields.io/badge/LangChain-LLMs-blue?style=flat&logo=python&logoColor=white)](https://python.langchain.com/) [![LangGraph](https://img.shields.io/badge/LangGraph-AgenticAI-blue?style=flat)](https://github.com/langgraph/langgraph) [![CrewAI](https://img.shields.io/badge/CrewAI-GenerativeAI-blue?style=flat)](https://crew.ai/)

### Others  
[![Flask](https://img.shields.io/badge/Flask-000000?style=flat&logo=flask&logoColor=white)](https://flask.palletsprojects.com/) [![Git](https://img.shields.io/badge/Git-F05032?style=flat&logo=git&logoColor=white)](https://git-scm.com/) [![Excel](https://img.shields.io/badge/Excel-217346?style=flat&logo=microsoft-excel&logoColor=white)](https://www.microsoft.com/excel)

### Additional Skills (No Badges)
- **Database Management**: MySQL, PostgreSQL, MongoDB  
- **Data Analysis Tools**: Excel, Power Query, Advanced Functions  
- **Statistical Techniques**: Hypothesis Testing, Regression Analysis, Statistical Modeling  
- **Other Technical Proficiencies**: NLP, Predictive Analytics, Agentic AI, Prompt Engineering, Anomaly Detection, Time Series Analysis
...
- **Email**: [shivamsinghapr15@gmail.com](mailto:shivamsinghapr15@gmail.comm)
- **GitHub**: [shivams-15](https://github.com/shivams-15)
- **LinkedIn**: [Shivam Singh](https://www.linkedin.com/in/shivamsingh0415/)
